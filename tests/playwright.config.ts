...
export default defineConfig({
  ...
  projects: [
    ...
    { name: 'auth-redirect', testMatch: 'auth-redirect.spec.ts', use: { headless: true, serviceWorkers: 'block' } },
    { name: 'invite-scope', testMatch: 'invite-scope.spec.ts', use: { headless: true, serviceWorkers: 'block' } },
    { name: 'rh-user-mutation', testMatch: 'rh-user-mutation.spec.ts', use: { headless: true, serviceWorkers: 'block' } },
