  ...
  admin: [
    {
      ...
      bullets: [
        ...
        'validar operação da plataforma em nível geral',
      ],
      note: 'Este perfil atua no escopo global da UniHER.',
    },
    {
      title: 'Comunicação e governança',
      description: 'Os módulos administrativos permitem organizar alertas, usuários e configurações com rastreabilidade.',
      bullets: [
        'gerenciar cadastros e permissões',
        'acompanhar configurações principais',
        'orientar a operação das empresas',
      ],
      note: 'As ações mais sensíveis ficam reservadas ao admin master.',
    },
    {
      ...
      note: 'Ao concluir, você segue para o painel principal.',
    },
  ],
  rh: [
    {
      title: 'Painel da empresa',
      description: 'Aqui você acompanha a operação da sua empresa e acessa rapidamente os módulos do dia a dia.',
      bullets: [
        'usuários, convites e departamentos',
        'campanhas, desafios e objetivos',
        'resumo rápido para reuniões e acompanhamento',
      ],
      note: 'Este perfil opera apenas o escopo da própria empresa.',
    },
    {
      title: 'Lições e conteúdo',
      description: 'As lições podem ser montadas com fluxo guiado, agendamento e validação antes da publicação.',
      bullets: [
        'escolher tipo, tema e agendamento',
        'editar ou validar antes da data',
        'organizar a experiência da colaboradora com clareza',
      ],
      note: 'O editor foi pensado para uso simples, inclusive no mobile.',
    },
    {
      title: 'Comunicação com colaboradoras',
      description: 'Você pode orientar a rotina com alertas, campanhas e notificações do próprio escopo.',
      bullets: [
        'comunicação por público permitido',
        'ações de engajamento e reforço',
        'alinhamento entre conteúdo e operação',
      ],
      note: 'A ideia é facilitar o uso real, não apenas exibir informações.',
    },
    {
      title: 'Jornada da colaboradora',
      description: 'A experiência final combina conteúdo, interação e recorrência de uso no celular.',
      bullets: [
        'painel com missões, lições e notificações',
        'conteúdo educativo e presença pessoal',
        'uso recorrente e instalação como PWA',
      ],
      note: 'Ao concluir, você confirma seus dados e entra na plataforma.',
    },
  ],
  lideranca: [
    {
      title: 'Visão de acompanhamento',
      description: 'A liderança acessa indicadores e acompanha a rotina da equipe dentro do escopo permitido.',
      bullets: [
        'monitorar andamento das ações',
        'acompanhar comunicações e engajamento',
        'manter visão objetiva da jornada da equipe',
      ],
      note: 'O foco é acompanhamento, não administração global.',
    },
    {
      title: 'Fluxo da colaboradora',
      description: 'A plataforma foi desenhada para incentivar recorrência e clareza de uso.',
      bullets: [
        'conteúdo diário e desafios',
        'engajamento com feedback visual',
        'experiência consistente no mobile',
      ],
      note: 'Ao concluir, você confirma seus dados e segue para o painel.',
    },
  ],
  colaboradora: [
    {
      title: 'Sua rotina na plataforma',
      description: 'A UniHER organiza conteúdo, interação e lembretes em uma experiência simples para o dia a dia.',
      bullets: [
        'lições e conteúdos diários',
        'notificações, desafios e orientações',
        'acompanhamento da própria jornada',
      ],
      note: 'O objetivo é tornar o uso leve, recorrente e claro.',
    },
    {
      title: 'Engajamento contínuo',
      description: 'A plataforma usa elementos de progresso para estimular constância sem perder simplicidade.',
      bullets: [
        'progresso educativo e feedback visual',
        'tarefas objetivas e navegação simples',
